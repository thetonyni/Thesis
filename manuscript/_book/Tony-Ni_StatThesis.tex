...
We will follow their criterion(s) for determining if a well is contaminated and most other aspects. The only difference in our case study is how we obtain the average concentrations of the contaminants in the wells. We will use our four different methods to obtain mean estimates of the concentrations while accounting for the values below the limit of detection and see if we obtain any different conclusions given our different methods.
...
As stated previously, Kelderman et al. (2019) compiled a list of the top 10 most contaminated sites across the U.S., following the EPA's health-based threshold for specific contaminants. We will briefly follow with a discussion on their methodology in determining these top 10 most contaminated sites.
...
After these values are obtained, any wells with average downgradient concentrations lower than the highest average upgradient concentration for that specific contaminant and disposal area -- were removed.

It is also important to note that since upgradient wells measure the quality of the water \emph{before} it passes through a coal site, they are also removed.

These two exclusion principles are followed to ensure that we did not use any wells that potentially had contamination from an external source, apart from the coal site.

The remaining average mean concentrations of the contaminants in question for each site are then compared to the health-based thresholds set by the EPA, these thresholds can be viewed in Table {[}PUT TABLE NUMBER HERE{]}.
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#CODE TO MAKE HEALTH BASED THRESHOLDS TABLE}
\end{Highlighting}
\end{Shaded}
For each site, the wells with the highest average concentration of each contaminant were identified and subseqeuently compared to their respective health-based thresholds. A ratio is then calculated for each of these highest average contaminants to the health-based thresholds. These contaminant-specific ratios are then summed together in order to get a cumulative ``contamination score'' for each site. Contamination scores of a higher magnitude indicates more ``severe'' contamination, with the top 10 highest contamination scores comprising the top 10 most contaminated sites.

tables below super ugly (FIX!!!!!)
\begin{tabular}{l|r}
\hline
site & n\\
\hline
Allen Steam Station & 9938\\
\hline
Jim Bridger Power Plant & 8932\\
\hline
Naughton Power Plant & 6485\\
\hline
San Miguel Plant & 4177\\
\hline
Ghent Generating Station & 3895\\
\hline
Hunter Power Plant & 2010\\
\hline
Brandywine Ash Management Facility & 1988\\
\hline
Allen Fossil Plant & 1952\\
\hline
New Castle Generating Station & 1749\\
\hline
R.D. Morrow, Sr. Generating Station & 1701\\
\hline
\end{tabular}
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#how many well are below detection in each site}
\NormalTok{keldermantop10df }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(site, below.detection) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarize}\NormalTok{(}\AttributeTok{n =} \FunctionTok{n}\NormalTok{()) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable}\NormalTok{() }\CommentTok{\#temporary table (ugly)}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
...
\begin{tabular}{l|l|r}
\hline
site & below.detection & n\\
\hline
Allen Fossil Plant & < & 776\\
\hline
Allen Fossil Plant &  & 1176\\
\hline
Allen Steam Station & < & 2748\\
\hline
Allen Steam Station &  & 7190\\
\hline
Brandywine Ash Management Facility & < & 490\\
\hline
Brandywine Ash Management Facility &  & 1498\\
\hline
Ghent Generating Station & < & 2027\\
\hline
Ghent Generating Station &  & 1868\\
\hline
Hunter Power Plant & < & 715\\
\hline
Hunter Power Plant &  & 1295\\
\hline
Jim Bridger Power Plant & < & 3671\\
\hline
Jim Bridger Power Plant &  & 5261\\
\hline
Naughton Power Plant & < & 2533\\
\hline
Naughton Power Plant &  & 3952\\
\hline
New Castle Generating Station & < & 809\\
\hline
New Castle Generating Station &  & 940\\
\hline
R.D. Morrow, Sr. Generating Station & < & 774\\
\hline
R.D. Morrow, Sr. Generating Station &  & 927\\
\hline
San Miguel Plant & < & 1370\\
\hline
San Miguel Plant &  & 2807\\
\hline
\end{tabular}
Blah Blah, talk about applying our methods to obtain new mean estimates, discuss how we will use kelderman's procedure to obtain our own top 10 sites (for each censoring method)

\hypertarget{our-top-10-sites}{%
\subsection{(Our) Top 10 Sites}\label{our-top-10-sites}}
