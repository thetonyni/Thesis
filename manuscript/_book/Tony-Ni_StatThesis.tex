...
Text here blah blah talk about wells in the US
\begin{center}\includegraphics{Tony-Ni_StatThesis_files/figure-latex/map-1} \end{center}

\hypertarget{keldermans-top-10-sites}{%
\subsection{Kelderman's Top 10 Sites}\label{keldermans-top-10-sites}}

Talk about about what kelderman did to get the top 10 most contaminated sites, what procedures/methodologies they used to determine that/etc.
...
\hypertarget{in-chapter-ref03-casestudy}{%
\section{In Chapter @ref\{03-casestudy\}:}\label{in-chapter-ref03-casestudy}}
\begin{Shaded}
\begin{Highlighting}[]
