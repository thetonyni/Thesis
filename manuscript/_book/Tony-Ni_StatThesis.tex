...
\centering
\begin{tabular}[t]{ll>{}p{7.6cm}}
\toprule
Contaminant & Exceedance Limit\\
\midrule
Antimony & 6 mcg/L\\
\addlinespace
Arsenic & 10 mcg/L\\
...
\end{verbatim}
We will follow their criterion(s) for determining if a well is contaminated, the specifics of which we will outline in the next section. The only difference in our case study is how we obtain the average concentrations of the contaminants in the wells. We will use our four different methods to obtain mean estimates of the concentrations while accounting for the values below the limit of detection and see if we obtain any different conclusions given our different methods.
