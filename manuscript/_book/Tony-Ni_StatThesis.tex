...
The dataset contains information regarding chemical concentrations at coal plants. A coal plant consists of multiple disposal areas for the coal ash that it produces. At each disposal area, there are specific locations that groundwater is being measured, known as wells, which represent an observation in the dataset.

There are two types of wells -- upgradient and downgradient wells. The variables consist of information regarding the specific chemical concentrations of each well, the details of which can be viewed in the table below.
\begin{table}
...
\midrule
State & state & State where the well is located in\\
\addlinespace
Site & site & Site where the well is located in\\
\addlinespace
Disposal Area & disposal.area & Disposal area where the well is located in\\
\addlinespace
Type of Well & type & Type of well\\
\addlinespace
ID of Well & well.id & ID of well\\
\addlinespace
Gradient Type & gradient & Gradient of the well\\
\addlinespace
Sample Date & samp.date & Date when the sample was collected\\
\addlinespace
Contaminant Name & contaminant & Name of contaminant being measured\\
\addlinespace
Measurement Unit & measurement.unit & Type of measurement unit for concentration\\
\addlinespace
Below Detection & below.detection & LOD status for the concentration\\
\addlinespace
