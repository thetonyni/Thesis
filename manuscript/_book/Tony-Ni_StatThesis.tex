...
Each of the four methods discussed in the previous chapter are designed for usage in obtaining summary statistics for left censored data (Shoari, 2018). Our goal is to estimate the mean of the censored variable of interest. We will be utilizing the four methods we discussed previously to achieve this.
