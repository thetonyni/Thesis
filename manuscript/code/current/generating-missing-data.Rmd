...
Assuming normal distribution (refer to technotes pdf file) for contaminant values in groundwater data...

Ok let's just try to pull random numbers from a Normal(10, 1) distribution for a "artificial" dataset.
...
The original mean and sd of our artificial dataset is 0.95 and 3.37 respectively.

The mean and sd we get from LOD/2 substitution method yields 9.613 and 1.97 respectively.

The mean and sd we get from LOD/sqrt(2 substitution method yields 9.812 and 1.45 respectively.
...
We obtain a mean of 10.24 and a sd of 0.82. This method performs much better than the substitution method!
