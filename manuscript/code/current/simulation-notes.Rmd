...
* come up with reasonable distribution, by comparing methods, we're trying to see which one better captures that distribution
...
* A: factors we might consider varying is the sample size $n$ and the percent of data censored (this may be too crazy, may have to prune down, ALSO CONSIDER UNDERLYING DISTRIBUTION)
...
* A:our final estimand is probably an indicator (is it over the threshold)
