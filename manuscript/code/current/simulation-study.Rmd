...
#incude true.value, estimated.value, bias, variance, mse, etc.
#also obtain sd alongside the mean
#also write up draft of simulation chapter draft in addition to updating simulation
